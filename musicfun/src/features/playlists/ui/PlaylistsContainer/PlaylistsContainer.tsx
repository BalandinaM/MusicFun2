...
//три варианта карточек сделать медиум маленькачя и большая, вероятно отпадет необходимость
//в optionCard, картинку отрисовывать просто через функцию в самой карточке, компонет картинкки удалить
//большая карточка не рендерится в списке, она сама по себе.
//не создавать константу cards а просто прямо в тегах отрисовывать нужный вид карточки
//опять же не понятно как передать карточке какой она должна быть
//может в жопу общий контенер... запрашивать
